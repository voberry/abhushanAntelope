        ...
        <div className="container">
          <div className="d-flex flex-fill w-100 justify-content-center">
              ...
              <ul className="nav justify-content-end lighten-4 py-4 nav-texts">
                <MDBNavItem>
                  <MDBDropdown>
                    ...
                    <MDBDropdownMenu>
                      <MDBDropdownItem>
                        <Link to="/our-services/places">Places</Link>
                      </MDBDropdownItem>
                      <MDBDropdownItem>
                        <Link to="/our-services/packages">Packages</Link>
                      </MDBDropdownItem>
                      <MDBDropdownItem>
                        <Link to="/our-services/hotels">Hotels</Link>
                      </MDBDropdownItem>
                      <MDBDropdownItem>
                        <Link to="/our-services/treks">Treks</Link>
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
                </MDBNavItem>
            ...
            <div>
              <MDBNavbarBrand
                className={
                  "nav justify-content-center lighten-4 mr-0 nav-header"
                }
              >
                  ...
                  <MDBNavItem>
                    <MDBDropdown>
                      <MDBDropdownToggle nav>
                        ...
                        />
                        <span className="ml-2 nav-text-span">
                      ...
                      <MDBDropdownMenu>
                        ...
                        <MDBDropdownItem>
                          <a onClick={authData.logout}>SignOut</a>
                        </MDBDropdownItem>
                      </MDBDropdownMenu>
                    </MDBDropdown>
                  </MDBNavItem>
