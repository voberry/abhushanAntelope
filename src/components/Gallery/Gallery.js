...
const Gallery = () => {
  ...
  return (
    <MDBAnimation type="fadeIn" duration="1s">
      ...
      <div className={"container-fluid p-5 mt-5 w-100"}>
        <h3
          className={`h3-responsive h3-lg antelope-green text-center font-weight-bolder  primary-font mt-5`}
        >
          YOUR JOURNEY WITH US.
        </h3>
        <h5
          className={`h5-responsive h5-lg text-center font-weight-bolder secondary-text`}
        >
          See the memories you've made
        </h5>
        <br />
        <div className={"container"}>
          <FsLightbox
            ...
            slide={state.slide}
            sources={[Pokhara, chitwan, kathmandu, aboutUs, carefree, notFound]}
          />
