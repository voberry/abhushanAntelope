...
const LocationInfo = props => {
  ...
  return (
    <div
      className="d-flex justify-content-around flex-fill mx-5"
      id={location && location.title}
    >
              ...
              <div className="row">
                ...
                <div className="col-lg-7 ">
                  <p className="green-text">
                    <h6 className="font-weight-bolder mb-3 grey-text">
                      <i className="fas fa-city pr-2" />
                      City of Temples
                    </h6>
                  </p>
                  <h3 className="font-weight-bolder mb-3 antelope-green text-uppercase">
                    <strong>{location && location.title}</strong>
                  </h3>
          ...
          <div>
            <Tabs defaultActiveKey="hotels">
              ...
              <TabPane tab="Restaurants" key="restaurants">
                <Carousels
                  locations={location}
                  selectedItemFor={"restaurants"}
                />
              </TabPane>
              <TabPane tab="Comments" key="comments">
                <div className="mb-3">
                  <h3 className="antelope-green">Additional Requests</h3>
                  {getFieldDecorator(
                    `locationInformation['${location.title}']['additionaRequests']`,
                    {}
                  )(
                    <textarea
        ...
        <div className="col-sm-12 col-md-3">
          <div className="card mt-5 flat-box-shadow">
            <div className="card-body">
              <h3 className="card-title antelope-green primary-font">
                {location.title} Packages
              </h3>
              ...
              {selectedHotel &&
                selectedHotel
                  ...
                  <div>
                    {getFieldDecorator(
                      `locationInformation['${location.title}']['hotel']`,
                      {
                        initialValue:
                          selectedHotel &&
                          selectedHotel.find(
                            item => item.location === location.title
                          ) &&
                          selectedHotel.find(
                            item => item.location === location.title
                          ).hotel,
                    ...
                    <h4 className="card-title antelope-green primary-font">
              ...
              {selectedVehicle &&
                selectedVehicle
                  ...
                  <div>
                    {getFieldDecorator(
                      `locationInformation['${location.title}']['vehicle']`,
                      {
                        initialValue:
                          selectedVehicle &&
                          selectedVehicle.find(
                            item => item.location === location.title
                          ) &&
                          selectedVehicle.find(
                            item => item.location === location.title
              ...
              {selectedRestaurants &&
                selectedRestaurants
                  ...
                  <div>
                    {getFieldDecorator(
                      `locationInformation['${location.title}']['restaurant']`,
                      {
                        initialValue:
                          selectedRestaurants &&
                    ...
                    <h4 className="card-title antelope-green primary-font">
                      Restaurant {selectedRestaurants.restaurant}
                    </h4>
                    <h6 className={"antelope-blue-light"}>Location, City</h6>
                    <div>
                      <i className={"fas fa-star yellow-text"} />
