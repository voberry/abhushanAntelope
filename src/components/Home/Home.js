...
const Home = props => {
  ...
  const handleDaysToggle = title => {
    console.log(`${title}-days-editable`);
          ...
          <div className="mask rgba-black-light flex-center">
            ...
            >
              <div>
                ...
                <h6
                  className={
                    !isSubmitted ? `text-center px-5 mx-5 white-text ` : `hide`
                  }
                >
                  With Antelope Nepal, you can create the holidays you dream of
                  from the click of your mouse, on the go. And we do it
                      ...
                      <div className="text-center">
                        <div>
                          ...
                          <h6 className="font-weight-bolder my-2 antelope-green">
                            ...
                            <div id={`${item.title}-days-editable`} style={{display: 'none'}}>
                            ...
                            })(<input className="form-control" onBlur={()=> handleDaysFormToggle(item.title)} />)}
                            </div>
                          </h6>
                        </div>
                      </div>
