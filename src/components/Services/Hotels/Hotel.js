                    ...
                    <div className="col-md-9 col-sm-12 p-5">
                        <div className="row">
                            ...
                            <div className="col-md-3 col-sm-12 ">
                                <button className={'btn antelope-green-bg-light white-text white-text btn-sm float-right mt-3'}>Book Now</button>
                            </div>
                        </div>
                        ...
                        <div className={'p-4 mt-4 antelope-green-bg-light white-text white-text'}>
                            <h4> Price : 1400/day
