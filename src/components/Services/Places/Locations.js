                        ...
                        <div className="row">
                            <div className="col-lg-12 col-sm-12 col-md-12 p-5">
                                ...
                                <a  className="green-text">
                                    <h6 className="font-weight-bolder mb-3 secondary-text"><i className="fas fa-city pr-2" />City of Temples</h6>
                                </a>
                                <h3 className="font-weight-bolder mb-3  "><strong>  {props.match.params.name}</strong></h3>
