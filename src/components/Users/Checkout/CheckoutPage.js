      ...
      <div className={"container-fluid p-5 w-100"}>
              ...
              <div className="card-body">
                ...
                <div className="list-group">
                  <a className="list-group-item list-group-item-action flex-column align-items-start">
                    ...
                    <p className="mb-1">
                      <div className="row">
                        <div className="col-3">Transportation :</div>

                        <div className="col-9">1 . Vehicles</div>
                      </div>
                      <br />
                      <div className="row">
                        <div className="col-3">Hotels :</div>

                        <div className="col-9">1 . ABC Hotels</div>
                      </div>
                      <br />
                      <div className="row">
                        <div className="col-3">Activities :</div>
        ...
        <div className="row mt-5">
          <div className="col-md-12">
            <div className="card">
              <div className="card-body">
                <h4 className={"font-weight-bolder antelope-green"}>
                  Point of Contact
                </h4>
